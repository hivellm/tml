...
- [Structs](ch03-00-structs.md)
    - [Defining and Instantiating Structs](ch03-01-defining-structs.md)
    - [An Example Program Using Structs](ch03-02-example-structs.md)
- [Enums](ch09-00-enums.md)
- [Collections](ch08-00-collections.md)

## Low-Level Operations

- [Bitwise Operations](ch04-00-bitwise-operations.md)
- [Pointers and References](ch05-00-pointers-and-references.md)
- [Memory Management](ch06-00-memory-management.md)
