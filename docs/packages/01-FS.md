...
extend File {
    ...
    public func open(path: impl AsRef[Path]) -> Outcome[This, IoError]
    effects: [io.file.read]

    /// Create file for writing (truncates if exists)
    public func create(path: impl AsRef[Path]) -> Outcome[This, IoError]
    effects: [io.file.write]

    /// Open with custom options
    public func open_with(path: impl AsRef[Path], opts: OpenOptions) -> Outcome[This, IoError]
    effects: [io.file]

    /// Get file metadata
    public func metadata(this) -> Outcome[Metadata, IoError]
    effects: [io.file.read]

    /// Sync all data to disk
    public func sync_all(this) -> Outcome[Unit, IoError]
    effects: [io.file.write]

    /// Sync data (not metadata) to disk
    public func sync_data(this) -> Outcome[Unit, IoError]
    effects: [io.file.write]

    /// Set file length
    public func set_len(this, size: U64) -> Outcome[Unit, IoError]
    effects: [io.file.write]

    /// Get current position
    public func position(this) -> Outcome[U64, IoError]

    /// Seek to position
    public func seek(this, pos: SeekFrom) -> Outcome[U64, IoError]
}
...
extend OpenOptions {
    ...
    public func mode(this, mode: U32) -> This { this.mode = Just(mode); this }

    public func open(this, path: impl AsRef[Path]) -> Outcome[File, IoError]
    effects: [io.file]
}
```
...
extend Metadata {
    ...
    public func modified(this) -> Outcome[SystemTime, IoError]
    public func accessed(this) -> Outcome[SystemTime, IoError]
    public func created(this) -> Outcome[SystemTime, IoError]
}
...
extend Path {
    public func new(s: ref str) -> ref This
    public func as_str(this) -> ref str
    public func to_path_buf(this) -> PathBuf
    public func parent(this) -> Maybe[ref Path]
    public func file_name(this) -> Maybe[ref str]
    public func file_stem(this) -> Maybe[ref str]
    public func extension(this) -> Maybe[ref str]
    public func join(this, path: impl AsRef[Path]) -> PathBuf
    public func with_extension(this, ext: ref str) -> PathBuf
...
extend PathBuf {
    ...
    public func set_file_name(this, name: ref str)
    public func set_extension(this, ext: ref str) -> Bool
    public func as_path(this) -> ref Path
}
```
...
extend DirEntry {
    public func path(this) -> ref Path
    public func file_name(this) -> ref str
    public func metadata(this) -> Outcome[Metadata, IoError]
    public func file_type(this) -> Outcome[FileType, IoError]
}
```
...
public func read_to_string(path: impl AsRef[Path]) -> Outcome[String, IoError]
effects: [io.file.read]
{
...
public func read(path: impl AsRef[Path]) -> Outcome[List[U8], IoError]
effects: [io.file.read]
{
    let mut file = File.open(path)!
...
/// Read file lines
public func read_lines(path: impl AsRef[Path]) -> Outcome[Lines, IoError]
effects: [io.file.read]
```
...
public func write_string(path: impl AsRef[Path], contents: ref str) -> Outcome[Unit, IoError]
effects: [io.file.write]
{
...
/// Write bytes to file
public func write(path: impl AsRef[Path], contents: ref [U8]) -> Outcome[Unit, IoError]
effects: [io.file.write]

/// Append to file
public func append(path: impl AsRef[Path], contents: ref [U8]) -> Outcome[Unit, IoError]
effects: [io.file.write]
```
...
```tml
/// Create directory
public func create_dir(path: impl AsRef[Path]) -> Outcome[Unit, IoError]
effects: [io.file.write]

/// Create directory and all parents
public func create_dir_all(path: impl AsRef[Path]) -> Outcome[Unit, IoError]
effects: [io.file.write]

/// Remove empty directory
public func remove_dir(path: impl AsRef[Path]) -> Outcome[Unit, IoError]
effects: [io.file.write]

/// Remove directory and all contents
public func remove_dir_all(path: impl AsRef[Path]) -> Outcome[Unit, IoError]
effects: [io.file.write]

/// Read directory entries
public func read_dir(path: impl AsRef[Path]) -> Outcome[ReadDir, IoError]
effects: [io.file.read]
...
public func set_current_dir(path: impl AsRef[Path]) -> Outcome[Unit, IoError]
effects: [io.file.write]
```
...
```tml
/// Copy file
public func copy(from: impl AsRef[Path], to: impl AsRef[Path]) -> Outcome[U64, IoError]
effects: [io.file]

/// Rename/move file
public func rename(from: impl AsRef[Path], to: impl AsRef[Path]) -> Outcome[Unit, IoError]
effects: [io.file.write]

/// Remove file
public func remove_file(path: impl AsRef[Path]) -> Outcome[Unit, IoError]
effects: [io.file.write]

/// Get file metadata
public func metadata(path: impl AsRef[Path]) -> Outcome[Metadata, IoError]
effects: [io.file.read]

/// Get symlink metadata (doesn't follow)
public func symlink_metadata(path: impl AsRef[Path]) -> Outcome[Metadata, IoError]
effects: [io.file.read]
...
public func canonicalize(path: impl AsRef[Path]) -> Outcome[PathBuf, IoError]
effects: [io.file.read]
```
...
/// Create symlink
@when(unix)
public func symlink(original: impl AsRef[Path], link: impl AsRef[Path]) -> Outcome[Unit, IoError]
effects: [io.file.write]

@when(windows)
public func symlink_file(original: impl AsRef[Path], link: impl AsRef[Path]) -> Outcome[Unit, IoError]
effects: [io.file.write]

@when(windows)
public func symlink_dir(original: impl AsRef[Path], link: impl AsRef[Path]) -> Outcome[Unit, IoError]
effects: [io.file.write]

/// Read symlink target
public func read_link(path: impl AsRef[Path]) -> Outcome[PathBuf, IoError]
effects: [io.file.read]
```
...
public func glob(pattern: ref str) -> Outcome[Glob, PatternError]
effects: [io.file.read]
...
extend TempFile {
    ...
    public func new() -> Outcome[This, IoError]
    effects: [io.file.write]

    /// Create temp file in specific directory
    public func new_in(dir: impl AsRef[Path]) -> Outcome[This, IoError]
    effects: [io.file.write]
    ...
    /// Get inner File
    public func as_file(this) -> ref File
    public func as_file_mut(this) -> mut ref File
}
...
extend IoError {
    ...
    public func raw_os_error(this) -> Maybe[I32]
}
```
...
public func list_tml_files(dir: ref Path) -> Outcome[List[PathBuf], IoError] {
    var files = List.new()
...
public func process_with_temp() -> Outcome[Unit, Error] {
    // Create temp file
