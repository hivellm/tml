...
- Current: 5 inline IR functions remain (2 string utils + 3 black_box); 7 live math builtin handlers; 0 C migration candidates; all primitive formatting uses TML Display behavior dispatch
