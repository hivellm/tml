...
| [03-functions.tml](03-functions.tml) | Function definitions, generics with `[T]`, references (`&`, `&mut`) |
...
| [06-error-handling.tml](06-error-handling.tml) | `!` operator, `else` recovery, `catch` blocks, `Result` |
| [07-traits.tml](07-traits.tml) | Trait definitions, `extend X with T` syntax, trait bounds |
...
| [12-memory.tml](12-memory.tml) | Ownership, borrowing, smart pointers (`Box`, `Rc`, `Arc`) |
