...
> **Note**: The stable ID implementation is in progress. See [RFC-0007-IR](../rfcs/RFC-0007-IR.md#3-stable-ids) for the normative content-addressable ID specification using base58 encoding.

### 5.1 Generation

IDs are 8-character content-addressable identifiers:
