...
| Concat Loop (Str - O(n^2)) | - | 3068 | TML only |
| Log Building (Text - O(n)) | - | 49 | TML only |
| Log Building (Str - O(n^2)) | - | 3819 | TML only |
...
| Operation | C++ (ns/op) | TML (ns/op) | Verdict |
|---|---:|---:|---|
| HashMap Insert | 280 | 24 | **TML 11.7x faster** |
| HashMap Insert (reserved) | 202 | 24 | **TML 8.4x faster** |
| HashMap Lookup | 5 | 1 | **TML 5.0x faster** |
| HashMap Contains | 4 | 1 | **TML 4.0x faster** |
| HashMap Remove | 296 | 13 | **TML 22.8x faster** |
| HashMap String Key | 436 | - | C++ only |
...
| Number Formatting | 517 | 86 | **TML 6.0x faster** |
| Log Messages | 46 | 38 | ~tied |
| Path Building | 23 | 9 | **TML 2.6x faster** |
| Text Append (O(1) amortized) | - | 46 | TML only |
| Str Naive Append (O(n^2)) | - | 3182 | TML only |
| Build JSON (10K items) | - | 91 | TML only |
...
| Operation | C++ (ns/op) | TML (ns/op) | Verdict |
|---|---:|---:|---|
| Base64 Encode (13 bytes) | 37 | 45 | C++ 1.2x |
| Base64 Encode (95 bytes) | 95 | 77 | ~tied |
| Base64 Decode (20 chars) | 64 | 39 | **TML 1.6x faster** |
| Hex Encode (13 bytes) | 36 | 40 | ~tied |
...
| Operation | C++ (ns/op) | TML (ns/op) | Verdict |
|---|---:|---:|---|
| SHA256 (13 bytes) | 339 | 398 | ~tied |
| SHA256 (95 bytes) | 346 | 415 | ~tied |
| SHA256 Streaming (3 updates) | 355 | 452 | C++ 1.3x |
| SHA512 (13 bytes) | 441 | 537 | C++ 1.2x |
| MD5 (13 bytes) | 343 | 419 | C++ 1.2x |
| SHA256 + to_hex (13 bytes) | 392 | 516 | C++ 1.3x |
...
|---|---|---|
| Parse Tiny (27 bytes) | 288 | 3,470,691 |
| Parse Small (200 bytes) | 1066 | 938,055 |
| Parse Medium (500 bytes) | 3013 | 331,822 |
| Parse Standard (non-SIMD) | 2076 | 481,476 |
| Field Access | 1068 | 936,101 |
| Array Iteration | 1153 | 866,763 |
| Nested Object Access | 1322 | 756,152 |
| Parse + Validate | 1044 | 957,620 |
| Object Traversal | 1063 | 940,518 |
