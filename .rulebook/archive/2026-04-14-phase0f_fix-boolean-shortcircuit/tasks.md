...
- [x] 5.1 Update documentation: CHANGELOG.md (v0.3.8 entry), VERSION 0.3.7 → 0.3.8, docs/patches/v0.3.8.md created with fix description, root cause, IR layout, and benchmark gate results
