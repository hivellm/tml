...
- [x] 5.2 Write tests covering the new behavior: `compiler/tests/compiler/insertvalue_struct.test.tml` — 8 tests for point/rect/point3d construction, inline literal, pass-by-value, loop, zero, negative values
- [x] 5.3 Run tests and confirm they pass: all 8 regression tests pass (1/1 suite pass); core 749/749, compiler 78/79 (pre-existing X002 timeout only)
