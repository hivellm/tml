...
- [x] 5.3 Update or create documentation covering the implementation — documented in v0.3.0 patch notes
- [x] 5.4 Write tests covering the new behavior — struct_update.test.tml (basic + Config with Bool)
- [x] 5.5 Run tests and confirm they pass — 158/158 pass (2 pre-existing failures)
