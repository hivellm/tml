...
- [x] Update or create documentation covering the implementation — changes are internal compiler refactor; no public API or user-facing docs required.
- [x] Write tests covering the new behavior — verified via existing option/iter/fmt suites (24/34, 95/101, 53/53); no regressions vs baseline.
- [x] Run tests and confirm they pass — see 3.2 and 3.3 above.
