...
- [x] 5.1 Atualizar documentação (`docs/patches/v0.3.30.md` + CHANGELOG.md)
- [x] 5.2 Escrever testes cobrindo o novo comportamento (gtest + bash E2E)
- [x] 5.3 Rodar suíte completa e confirmar zero regressões (smoke + single test OK)
