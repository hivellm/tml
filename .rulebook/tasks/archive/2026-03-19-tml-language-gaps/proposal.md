...
Fix codegen bugs blocking idiomatic TML usage: Bool/i1 struct through fn pointers (SEGFAULT), dyn Behavior dispatch (invalid IR), and async/await type mismatch (i64 vs i32). All three were codegen issues, not missing features.
