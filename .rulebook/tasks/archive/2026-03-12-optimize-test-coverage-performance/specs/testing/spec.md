...
The test coordinator SHALL begin executing completed test EXEs while other suites are still compiling, rather than waiting for all compilations to complete before starting execution.
