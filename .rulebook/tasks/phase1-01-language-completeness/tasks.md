...
**Status**: In Progress — 41% (70/172). Needs cleanup: some items duplicated in other tasks, some items don't belong in stdlib
...
⚠️ MOVED TO EXTERNAL LIBS — These serialization formats should be external packages, not stdlib. Remove from this roadmap.
...
⚠️ HTTP items are tracked in phase3-01-http-performance. This section is DEPRECATED — do not duplicate work here.
...
⚠️ LSP has NO C++ implementation yet. Phase 4.2-4.12 require building from scratch.
