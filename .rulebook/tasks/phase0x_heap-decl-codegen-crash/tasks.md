...
- [x] 5.1 Updated CHANGELOG.md with the codegen fix
- [x] 5.2 Documented the bug class in docs/patches/v0.3.39.md
- [x] 5.3 Ran the full compiler suite (`tml test --suite=compiler --no-fail-fast`) — 298/317 pass, all 19 failures pre-existing, no regressions from this fix
