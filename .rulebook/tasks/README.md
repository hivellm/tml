...
| 3 | ~~fix-codegen-coverage-blockers~~ | **ARCHIVED** | 44/44 | Archived 2026-03-21 |

## Tier 2: Medium Priority (product features)

| # | Task | Status | Progress | Next step |
|---|------|--------|----------|-----------|
| 4 | **http-production-server** | 83% | 59/71 | Phase 1-6+8-9 DONE. Remaining: IOCP scaling, memory opt, SIMD, zero-copy |
...
| fix-codegen-coverage-blockers | 44/44: all 5 phases complete — generics, intrinsics, closures, constants |
