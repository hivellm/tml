...
## 5. Tail (mandatory)
- [x] 5.1 VERSION bumped 0.3.47 → 0.3.48. CHANGELOG.md row added. `docs/patches/v0.3.48.md` written with root cause, fix, files changed, verification numbers (per-repro 30/30 and essential.c progress), and next blockers.
- [x] 5.2 Tests written (1.4) and existing baseline verified (4.5/4.6).
- [x] 5.3 Run all tests and confirm pass — c_parser passes after recompile; full compiler suite matches baseline.
