...
void TypeEnv::init_builtin_collections() {
    ...
    functions_["list_create"].push_back(FuncSig{
        "list_create",
        {},
        make_ptr(make_unit()),
        {},
    ...
    functions_["list_destroy"].push_back(FuncSig{
        "list_destroy",
        {make_ptr(make_unit())},
        make_unit(),
        {},
    ...
    functions_["list_pop"].push_back(FuncSig{
        "list_pop",
        {make_ptr(make_unit())},
        make_i32(),
        {},
    ...
    functions_["list_set"].push_back(FuncSig{
        "list_set",
    ...
    functions_["list_len"].push_back(FuncSig{
        "list_len",
        {make_ptr(make_unit())},
        make_i32(),
        {},
    ...
    functions_["list_capacity"].push_back(FuncSig{
        "list_capacity",
        {make_ptr(make_unit())},
        make_i32(),
        {},
    ...
    functions_["list_clear"].push_back(FuncSig{
        "list_clear",
        {make_ptr(make_unit())},
        make_unit(),
        {},
    ...
    functions_["list_is_empty"].push_back(FuncSig{
        "list_is_empty",
        {make_ptr(make_unit())},
        make_bool(),
        {},
    ...
    functions_["hashmap_create"].push_back(FuncSig{
        "hashmap_create",
        {},
        make_ptr(make_unit()),
        {},
    ...
    functions_["hashmap_destroy"].push_back(FuncSig{
        "hashmap_destroy",
        {make_ptr(make_unit())},
        make_unit(),
        {},
    ...
    functions_["hashmap_set"].push_back(FuncSig{
        "hashmap_set",
        {make_ptr(make_unit()), make_i32(), make_i32()},
        make_unit(),
        {},
    ...
    functions_["hashmap_remove"].push_back(FuncSig{
        "hashmap_remove",
        {make_ptr(make_unit()), make_i32()},
        make_bool(),
        {},
    ...
    functions_["hashmap_len"].push_back(FuncSig{
        "hashmap_len",
        {make_ptr(make_unit())},
        make_i32(),
        {},
    ...
    functions_["hashmap_clear"].push_back(FuncSig{
        "hashmap_clear",
        {make_ptr(make_unit())},
        make_unit(),
        {},
    ...
    functions_["buffer_create"].push_back(FuncSig{
        "buffer_create",
        {},
        make_ptr(make_unit()),
        {},
    ...
    functions_["buffer_destroy"].push_back(FuncSig{
        "buffer_destroy",
        {make_ptr(make_unit())},
        make_unit(),
        {},
    ...
    functions_["buffer_write_byte"].push_back(FuncSig{
        "buffer_write_byte",
        {make_ptr(make_unit()), make_i32()},
        make_unit(),
        {},
    ...
    functions_["buffer_write_i32"].push_back(FuncSig{
        "buffer_write_i32",
        {make_ptr(make_unit()), make_i32()},
        make_unit(),
        {},
    ...
    functions_["buffer_read_byte"].push_back(FuncSig{
        "buffer_read_byte",
        {make_ptr(make_unit())},
        make_i32(),
        {},
    ...
    functions_["buffer_read_i32"].push_back(FuncSig{
        "buffer_read_i32",
        {make_ptr(make_unit())},
        make_i32(),
        {},
    ...
    functions_["buffer_len"].push_back(FuncSig{
        "buffer_len",
        {make_ptr(make_unit())},
        make_i32(),
        {},
    ...
    functions_["buffer_capacity"].push_back(FuncSig{
        "buffer_capacity",
        {make_ptr(make_unit())},
        make_i32(),
        {},
    ...
    functions_["buffer_remaining"].push_back(FuncSig{
        "buffer_remaining",
        {make_ptr(make_unit())},
        make_i32(),
        {},
    ...
    functions_["buffer_clear"].push_back(FuncSig{
        "buffer_clear",
        {make_ptr(make_unit())},
        make_unit(),
        {},
