...
void TypeEnv::init_builtin_atomic() {
    ...
    functions_["atomic_load"].push_back(FuncSig{
        "atomic_load",
        {make_ptr(make_unit())},
        make_i32(),
        {},
    ...
    functions_["atomic_exchange"].push_back(FuncSig{
        "atomic_exchange",
        {make_ptr(make_unit()), make_i32()},
        make_i32(),
        {},
    ...
    functions_["atomic_cas"].push_back(FuncSig{
        "atomic_cas",
    ...
    functions_["atomic_cas_val"].push_back(FuncSig{
        "atomic_cas_val",
        {make_ptr(make_unit()), make_i32(), make_i32()},
        make_i32(),
        {},
    ...
    functions_["fence"].push_back(FuncSig{
        "fence",
        {},
        make_unit(),
        {},
    ...
    functions_["fence_acquire"].push_back(FuncSig{
        "fence_acquire",
        {},
        make_unit(),
        {},
    ...
    functions_["fence_release"].push_back(FuncSig{
        "fence_release",
        {},
        make_unit(),
        {},
