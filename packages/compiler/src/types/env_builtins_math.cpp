...
void TypeEnv::init_builtin_math() {
    ...
    functions_["sqrt"].push_back(FuncSig{
        "sqrt",
        {make_i32()},
        make_i32(),
        {},
    ...
    functions_["pow"].push_back(FuncSig{
        "pow",
        {make_i32(), make_i32()},
        make_i32(),
        {},
    ...
    functions_["abs"].push_back(FuncSig{
        "abs",
        {make_i32()},
        make_i32(),
        {},
    ...
    functions_["floor"].push_back(FuncSig{
        "floor",
        {make_i32()},
        make_i32(),
        {},
    ...
    functions_["ceil"].push_back(FuncSig{
        "ceil",
        {make_i32()},
        make_i32(),
        {},
    ...
    functions_["round"].push_back(FuncSig{
        "round",
        {make_i32()},
        make_i32(),
        {},
    ...
    functions_["black_box"].push_back(FuncSig{
        "black_box",
        {make_i32()},
        make_i32(),
        {},
    ...
    functions_["black_box_i64"].push_back(FuncSig{
        "black_box_i64",
        {make_i64()},
        make_i64(),
        {},
