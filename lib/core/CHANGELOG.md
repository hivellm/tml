...
### Changed
- **for-in loop migration** — replaced ~50 manual index loops with `for i in 0 to N` syntax across `array/mod.tml`, `str/simd.tml`, `str/transform.tml`, `str/search.tml`, `str/convert.tml`, `str/parse.tml`, `simd/algorithms.tml`, `simd/sse42.tml`, `simd/u8x32.tml`, `simd/i16x16.tml`, `data/cache.tml`
