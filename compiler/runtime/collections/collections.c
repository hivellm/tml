 ...
 *
 * Implements List (C-level, used by string.c) and Buffer.
 *
 * Note: List[T] and HashMap[K,V] TML types are now pure TML.
 ...
 *
 * HashMap C functions have been removed — now pure TML
 * (see lib/std/src/collections/hashmap.tml)
 */
