...
// NOTE: Legacy List/HashMap/Buffer bare-function codegen tests removed (Phase 43).
// These types are now pure TML — List[T] in list.tml, HashMap[K,V] in hashmap.tml,
// Buffer in buffer.tml. Bare function names like list_create(), hashmap_get(), etc.
// are no longer part of the codegen pipeline.
