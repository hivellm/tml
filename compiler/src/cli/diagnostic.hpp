...
constexpr const char* CONST_INIT_TYPE_MISMATCH = "T055";
constexpr const char* BINDING_TYPE_MISMATCH = "T056";
constexpr const char* PTR_ARG_TYPE_MISMATCH = "T057";
constexpr const char* OVERRIDE_PARAM_TYPE_MISMATCH = "T058";
constexpr const char* STRUCT_LITERAL_UNKNOWN_FIELD = "T059";
constexpr const char* UNION_LITERAL_FIELD_COUNT = "T060";
constexpr const char* STRUCT_MISSING_FIELD = "T061";
constexpr const char* STRUCT_UPDATE_TYPE_MISMATCH = "T062";
constexpr const char* OVERRIDE_NO_BASE_CLASS = "T063";
constexpr const char* OVERRIDE_NOT_VIRTUAL = "T064";
constexpr const char* OVERRIDE_NOT_FOUND = "T065";
constexpr const char* INVALID_NEW_CLASS = "T066";
constexpr const char* BASE_FIELD_NOT_FOUND = "T067";
constexpr const char* TUPLE_PATTERN_NON_TUPLE = "T068";
constexpr const char* ENUM_PATTERN_NON_ENUM = "T069";
constexpr const char* STRUCT_PATTERN_NON_STRUCT = "T070";
constexpr const char* ARRAY_PATTERN_NON_ARRAY = "T071";
constexpr const char* STRUCT_PATTERN_UNKNOWN_FIELD = "T072";
constexpr const char* CLASS_FIELD_NOT_FOUND = "T073";
constexpr const char* PTR_FIELD_NOT_FOUND = "T074";
constexpr const char* CLASS_NOT_FOUND = "T075";
constexpr const char* BASE_CLASS_UNDEFINED = "T076";
constexpr const char* BASE_METHOD_NOT_FOUND = "T077";
constexpr const char* CLASS_METHOD_NOT_FOUND = "T078";
constexpr const char* BEHAVIOR_METHOD_NOT_FOUND = "T079";
constexpr const char* PTR_READ_ARGS = "T080";
constexpr const char* PTR_WRITE_ARGS = "T081";
constexpr const char* PTR_IS_NULL_ARGS = "T082";
constexpr const char* PTR_OFFSET_ARGS = "T083";
constexpr const char* PTR_UNKNOWN_METHOD = "T084";
...
constexpr const char* CODEGEN_MISSING_ARG = "C015";
constexpr const char* CODEGEN_MISSING_CLOSURE = "C016";
constexpr const char* CODEGEN_MISSING_FUNC_ARG = "C017";
constexpr const char* CODEGEN_MISSING_TWO_ARGS = "C018";
constexpr const char* CODEGEN_PTR_MISSING_ARG = "C019";
constexpr const char* CODEGEN_CLOSURE_SECOND_ARG = "C020";
constexpr const char* CODEGEN_REQUIRES_CLOSURE_OR_FUNC = "C021";
constexpr const char* CODEGEN_TUPLE_NO_INIT = "C022";
constexpr const char* CODEGEN_COMPOUND_ASSIGN_LHS = "C023";
constexpr const char* CODEGEN_NOT_CALLABLE_FIELD = "C024";
constexpr const char* CODEGEN_INVALID_IS_TYPE = "C025";
constexpr const char* CODEGEN_REF_REQUIRES_VAR = "C026";
constexpr const char* CODEGEN_FIELD_RESOLVE_ERROR = "C027";
constexpr const char* CODEGEN_VTABLE_CLASS_NOT_FOUND = "C028";
constexpr const char* CODEGEN_BASE_NO_CONTEXT = "C029";
constexpr const char* CODEGEN_BASE_NO_PARENT = "C030";
constexpr const char* CODEGEN_BASE_CLASS_NOT_FOUND = "C031";
constexpr const char* CODEGEN_CLASS_NOT_FOUND = "C032";
constexpr const char* CODEGEN_VTABLE_METHOD_NOT_FOUND = "C033";
constexpr const char* CODEGEN_BASE_FIELD_NOT_FOUND = "C034";
constexpr const char* CODEGEN_STATIC_METHOD_NOT_FOUND = "C035";
...
constexpr const char* LEX_INVALID_INT_SUFFIX = "L016";
constexpr const char* LEX_INVALID_FLOAT_SUFFIX = "L017";
constexpr const char* LEX_MISSING_EXPONENT = "L018";
constexpr const char* LEX_INVALID_FLOAT = "L019";
constexpr const char* LEX_INVALID_INTEGER = "L020";
